...
?><main class="pwf-services">
    ...
    <?php if (is_user_logged_in()){
        ?><p id="pwf-services-search-submit" class="pwf-services-search-button">submit</p>
    <?php } else {
        ?><p id="pwf-services-search-submit--preview" class="pwf-services-search-button">submit</p>
    <?php }
